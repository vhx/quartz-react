...
var ToggleCheckbox = function () { return (
  React__default.createElement( 'span', null,
    React__default.createElement( 'span', { className: styles$2.checkboxIcon }),
    React__default.createElement( 'span', { className: styles$2.checkboxCircle },
      ...
      React__default.createElement( 'fieldset', { className: getClassName$2(props) },
        ...
        React__default.createElement( 'label', { htmlFor: props.uniqueId },
          React__default.createElement( 'span', { className: styles$2.checkboxContain },
            ...
            React__default.createElement( 'span', { className: styles$2.checkboxLabel }, props.label)
          )
        )
      )
    )
...
var Header$1 = function (ref) {
  ...
  return (
    React__default.createElement( 'div', { className: containerClasses(border) },
      React__default.createElement( 'div', { className: styles$3.mediaColumnWrapper },
        React__default.createElement( 'div', { className: styles$3.media },
          React__default.createElement( 'div', { className: styles$3.mediaIconUnit },
            React__default.createElement( Icon$1, { name: icon, size: 'large' })
          ),
          React__default.createElement( 'div', { className: styles$3.mediaTextUnit },
            React__default.createElement( 'h2', { className: styles$3.headerTitle }, title),
            React__default.createElement( 'div', { className: styles$3.headerDescription }, typeof Description === 'string' ? Description : React__default.createElement( Description, null )
            )
          )
        )
      ),
      React__default.createElement( 'div', { className: styles$3.headerColumnOptionsWrapper }, children)
    )
  );
};
